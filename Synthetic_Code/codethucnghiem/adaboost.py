...
model = AdaBoostClassifier(n_estimators=50, random_state=42)  # Có thể điều chỉnh số lượng cây (n_estimators) và các tham số khác
...
for train_index, test_index in k_fold.split(X, y):
    ...
    # Khởi tạo mô hình AdaBoost trong mỗi fold
